        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              ...
              <button type="button" className="btn rte" data-bs-dismiss="modal" aria-label="Close">X</button>
            </div>
              ...
              <fieldset>
                <div className="form-group row">
                  <div className="form-floating col-sm-12 ">
                    <textarea className="form-control textarea-no-resize" maxLength={50} name='caption' placeholder={`Que estas pensando? ${usuario}`} value={caption} onChange={captionHandler} id="floatingTextarea"></textarea>
                  </div>
                </div>
                <div className="form-group row">
                ...
                dataMuro.map((item) => (
                  <div key={item.id} className="card text-white bg-secondary mx-auto " bis_skin_checked="1">
                    <div className="card-header" bis_skin_checked="1">
                      <div className="content-nom-fech">
                      ...
                      <button type="button" onClick={() => deletPublicacion(item.id)} className="btn btn-secondary dropdown-toggle">
                        <svg xmlns="http://www.w3.org/2000/svg" width={15} height={15} viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" /></svg>
                      </button>
                    </div>
